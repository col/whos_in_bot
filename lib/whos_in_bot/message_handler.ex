defmodule WhosInBot.MessageHandler do
  ...
  # end
  #
  # def execute_command(message = %{ command: "end_roll_call" }) do
  #   RollCall.close_existing_roll_calls(message)
  #   {:ok, "Roll call ended"}
  # end
  #
  # def execute_command(message = %{ command: "in" }) do
  ...
  # end
  #
  # def execute_command(message = %{ command: "out" }) do
  #   {:ok, roll_call_response} = RollCall.update_attendance(message, "out")
  #   {:ok, RollCall.attendance_updated_message(message.roll_call, roll_call_response)}
  # end
  #
  # def execute_command(message = %{ command: "maybe" }) do
  #   {:ok, roll_call_response} = RollCall.update_attendance(message, "maybe")
  #   {:ok, RollCall.attendance_updated_message(message.roll_call, roll_call_response)}
  # end
  #
  # def execute_command(message = %{ command: "whos_in"}) do
  #   {:ok, RollCall.whos_in_list(message.roll_call)}
  # end
  #
  # def execute_command(message = %{ command: "set_title" }) do
  #   title = Enum.join(message.params, " ")
  #   RollCall.set_title(message.roll_call, title)
  #   {:ok, "Roll call title set"}
  # end
  #
  # def execute_command(%{ command: "set_in_for", params: [] }) do
  #   {:ok, "Please provide the persons first name.\n"}
  # end
  #
  # def execute_command(message = %{ command: "set_in_for" }) do
  #   set_state_for(message, "in")
  #   {:ok, RollCall.whos_in_list(message.roll_call)}
  # end
  #
  # def execute_command(%{ command: "set_out_for", params: [] }) do
  #   {:ok, "Please provide the persons first name.\n"}
  # end
  #
  # def execute_command(message = %{ command: "set_out_for" }) do
  #   set_state_for(message, "out")
  #   {:ok, RollCall.whos_in_list(message.roll_call)}
  # end
  #
  # def execute_command(%{ command: "set_maybe_for", params: [] }) do
  #   {:ok, "Please provide the persons first name.\n"}
  # end
  #
  # def execute_command(message = %{ command: "set_maybe_for" }) do
  #   set_state_for(message, "maybe")
  #   {:ok, RollCall.whos_in_list(message.roll_call)}
  # end
  #
  # def execute_command(message = %{ command: "shh" }) do
  ...
  # end
  #
  # def execute_command(message = %{ command: "louder" }) do
